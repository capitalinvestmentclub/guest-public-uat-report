(() => {
  ...
  function activeFilterText() {
    ...
    return parts.length ? parts.join(' · ') : 'Full Guest/Public record';
  }
  ...
  function openFinding(id, updateHash = true) {
    ...
    elements.dialogContent.innerHTML = `
      ...
      <section class="detail-section">
        <h3>Lifecycle</h3>
        <div class="timeline">
          <div class="timeline-item done"><strong>Finding recorded</strong><small>${finding.scenario} · Guest/Public Chrome evidence run</small></div>
  ...
  function exportCsv() {
    ...
    link.download = 'guest-public-uat-findings.csv';
    link.click();
